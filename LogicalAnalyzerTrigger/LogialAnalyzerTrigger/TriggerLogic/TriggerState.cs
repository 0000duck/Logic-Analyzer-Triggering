...
namespace LogialAnalyzerTrigger
{
    ...
    public class TriggerState
    {
        ...
        private List<TriggerForkedState> _triggerStateForkedStatements;

        public TriggerState()
        {
            _triggerStateForkedStatements = new List<TriggerForkedState>();
        }
        ...
        public void AddTriggerStateForkedStatement(TriggerForkedState triggerStateForkedStatement)
        {
