...
namespace LogialAnalyzerTrigger.Statement
{
    public class RisingEdge : Statement
    {
        ...
        public override string ToString()
        {
            ...
            {
                case LogialAnalyzerTrigger.Statement.CompareTo.SignalValue:
                    return base.Signal.Name + " On Rising edge of " + base.CompareSignal.Name;
                case LogialAnalyzerTrigger.Statement.CompareTo.StaticVariable:
                    return base.Signal.Name + " On Rising edge of " + base.CompareVariable;
                default:
                    return "";
            }
        }
