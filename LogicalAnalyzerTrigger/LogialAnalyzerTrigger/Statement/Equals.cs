...
namespace LogialAnalyzerTrigger.Statement
{
    ...
    public class Equals : Statement
    {
        ...
        public Equals(Signal signal, double value)
            : base(signal, value)
        {
        ...
        public Equals(Signal signal, Signal compareSignal)
        ...
        public override string ToString()
        {
            ...
            {
                case LogialAnalyzerTrigger.Statement.CompareTo.SignalValue:
                    return base.Signal.Name + " Equals " + base.CompareSignal.Name;
                case LogialAnalyzerTrigger.Statement.CompareTo.StaticVariable:
                    return base.Signal.Name + " Equals " + base.CompareVariable;
                default:
                    return "";
            }
        }
